...
class EventDetected:
    def preprocess_frame(self, manager, detection_results, line_crossing_coords=None):
        ...
        detection_utils.preprocess_frame(detection_results, event_input.iot_event_zone_coords, event_input.camera_event_zone_coords, manager.is_ai_event, event_input.tracker, line_crossing_coords)
