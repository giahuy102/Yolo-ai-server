...
class EventDetected:
    def preprocess_frame(self, manager, detection_results, line_crossing_coords=None):
        ...
        detection_utils.preprocess_frame(detection_results, frame_info.iot_event_zone_coords, frame_info.camera_event_zone_coords, True, frame_info.tracker, line_crossing_coords)
